...
include 'middle.php';
	...
	$tutname = $pagr['name'];
	mysql_query("UPDATE tutorialpages SET isactive = '1' WHERE pageID = '$pageid'");
	$thenow = gmt("U");
	mysql_query("INSERT INTO alertuser (alertuser,alerter,alerttype,alertdate,alertlink,alertcontent,isnew) VALUES ('$author','$usr','11','$thenow','$tutid','A new page to your tutorial, $tutname, has been added.','1')");
