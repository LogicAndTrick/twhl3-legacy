...
<div class="single-center">
	<h1>Thanks!</h1>
        ...
        <p class="single-center-content">
            Thank you for registering for TWHL! To finalise your account creation, you must verify it.
        ...
        <? } else { ?>
        <p class="single-center-content">
            Thank you for registering for TWHL! You may now log in from the <a href="index.php">home page</a> or the form below. Please enjoy your stay!
        </p>
...
<div class="single-center" id="gap-fix-bottom">
    ...
    <div id="registration_form">
        ...
        <p class="single-center-content">
            <em>JavaScript needs to be enabled to use the registration form.</em>
        </p>
    </div>
        <?php /**/ ?>
<?php /*
