...
include 'middle.php';
	...
	mysql_query("UPDATE tutorialpages SET isactive = '2' WHERE pageID = '$pageid'");
	$thenow = gmt("U");
	mysql_query("INSERT INTO alertuser (alertuser,alerter,alerttype,alertdate,alertlink,alertcontent,isnew) VALUES ('$author','$usr','12','$thenow','$tutid','Your request for a new page in your tutorial, $tutname, has been refused.','1')");
