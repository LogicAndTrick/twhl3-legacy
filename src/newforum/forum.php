...
<TD BGCOLOR="#F1EFD7" ALIGN="right">
  ...
  <A HREF="JavaScript:smilie(':combine:')"><IMG SRC="newforum/smilies/combine.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':gak:')"><IMG SRC="newforum/smilies/gak.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':^_^:')"><IMG SRC="newforum/smilies/animehappy.png" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':pwned:')"><IMG SRC="newforum/smilies/pwnt.png" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':target:')"><IMG SRC="newforum/smilies/target.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':ninja:')"><IMG SRC="newforum/smilies/ninja.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':hammer:')"><IMG SRC="newforum/smilies/hammer.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':pirate:')"><IMG SRC="newforum/smilies/pirate.png" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':walter:')"><IMG SRC="newforum/smilies/walter.png" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':plastered:')"><IMG SRC="newforum/smilies/plastered.png" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  </TR></TD><TR><TD>
  
  <A HREF="JavaScript:smilie(':zomg:')"><IMG SRC="newforum/smilies/bigmouth.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':heartbreak:')"><IMG SRC="newforum/smilies/brokenheart.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':ciggie:')"><IMG SRC="newforum/smilies/ciggiesmilie.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':combines:')"><IMG SRC="newforum/smilies/combines.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':crowbar:')"><IMG SRC="newforum/smilies/crowbar.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':death:')"><IMG SRC="newforum/smilies/death.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':freeman:')"><IMG SRC="newforum/smilies/freeman.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':hecu:')"><IMG SRC="newforum/smilies/hecu.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':nya:')"><IMG SRC="newforum/smilies/nya.png" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  <A HREF="JavaScript:smilie(':rly:')"><IMG SRC="newforum/smilies/orly.gif" WIDTH="15" HEIGHT="15" BORDER="0"></A>
  </TR></TD></TABLE>
</TD>
...
$threadPostCount = mysql_result (mysql_query ("SELECT COUNT(post_id) FROM twhl_forumposts WHERE topic = " . $id, $GLOBALS['dbh']), 0, 0);
?>
<?setpages('threads',$threadPostCount)?>
<?=tblhead()?>
...
<DIV ALIGN="right"><?=pagelinks()?> | Posts: <?=$threadPostCount?> | <A HREF="#reply">Reply</A></DIV>
<?=tblbody()?>
...
} elseif ($prow['post_id'] == $lastpostdetail['0'] && $prow['poster'] == $_SESSION['uid'] && $_SESSION['uid'] != 3206) {
...
if (!isset($_SESSION['forumimages']) || $_SESSION['forumimages']) { ?>
	<DIV ALIGN="center">
	<?if ($prow["poster"] == 1983) { ?>
		<IMG SRC="pengav.php?time=<?=date("U")?>" ALT="Avatar">
...
function create_topic($id) {
  ...
  if ($user == 3206) {
	  $body = "[url=http://www.acc.umu.se/~zqad/cats/][img]http://www.acc.umu.se/~zqad/cats/1174330218-1174140490498.b.jpg[/img][/url]";
}
...
function create_reply($id) {
  ...
  if ($user == 3206) { $body = "[url=http://www.acc.umu.se/~zqad/cats/][img]http://www.acc.umu.se/~zqad/cats/1174330218-1174140490498.b.jpg[/img][/url]"; }
